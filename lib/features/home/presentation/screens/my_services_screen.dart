...
/// Just the service list, with no [Scaffold]/[AppBar]/[AppDrawer] of its
/// own — reused as-is inside [MyServicesScreen] (mobile/tablet) and as the
/// desktop 3-pane shell's trailing sidebar (`HomeShell`).
